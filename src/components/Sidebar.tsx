...
export const ProfileSidebar = () => {
    ...
    useEffect(() => {
        ...
        const fetchBMC: () => Promise<void> = async () => {
            ...
            if (supportersCount >= 0) {
                ...
                console.log("No BMC Supporters found.");
            }
        };
    ...
    useEffect(() => {
        ...
        const detectAppInstallation = () => {
            window.matchMedia("(display-node: standalone)").addEventListener("change", (e) => {
    ...
    return (
        <Container>
            ...
            >
                ...
                <MenuLink to="https://github.com/AdityaJha012/Todo-App">
                ...
                <MenuLink to="https://github.com/AdityaJha012/Todo-App/issues/new">
                    <StyledMenuItem>
                ...
                <MenuLink to="https://www.buymeacoffee.com/AdityaJha012">
                ...
                <ProfileOptionsBottom>
                    ...
                    <CreditsContainer translate="no">
                        ...
                        <a 
                            ...
                            href="https://github.com/AdityaJha012"
                        >Aditya</a>
                    </CreditsContainer>
            ...
            <Dialog open={openInstalledDialog} onClose={() => setOpenInstalledDialog(false)}>
                <CustomDialogTitle 
                    ...
                    subTitle="The app is now running as PWA."
