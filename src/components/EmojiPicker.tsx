...
export const CustomEmojiPicker = ({ emoji, setEmoji, color, name, type }: EmojiPickerProps) => {
    ...
    // https://afficone.com/blg/window-ai-new-chrome-feature-api/
    async function useAI(): Promise<void> {
        // TODO: make this a hook
        // https://rebeccamdeprey.com/bog/a-react-hook-for-windowai-in-chrome
        ...
        try {
            ...
            // this doesn't split emojis into seperate characters
            const emojiRegex = 
                            ...
                            {!isOnline && emojisStyle !== EmojiStyle.NATIVE && (
                                <Box sx={{ mx: "14px", mb: "16px" }}>
                                    <Alert severity="warning">
                                        Emojis may not load properly when offline. Try switching to the native style.
                                    </Alert>
                                    <Button
                                        variant="outlined"
                                        color="warning"
