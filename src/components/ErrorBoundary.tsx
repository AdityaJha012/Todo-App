            ...
            return (
                <Container>
                    ...
                    <h2>
                        ...
                        <StyledLink translate="no" href="https://github.com/AdityaJha012/Todo-App/issues">
                            Github Issues
                        </StyledLink>
                        .
                    </h2>
                    ...
                    <Dialog open={this.state.openClearDialog} onClose={this.handleCloseDialog}>
                        ...
                        />
                        <DialogContent>
                            Are you sure you want to clear all data? You will lose all of your tasks.
                        </DialogContent>
                        <DialogActions>
