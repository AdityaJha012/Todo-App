...
export const ColorPicker: React.FC<ColorPickerProps> = ({
    ...
    const colorElementsRefs = useRef<Array<HTMLElement | null>>([]);
                            ...
                            {[theme.primary, ...colorList].map((color, index) => (
                                <Grid item key={color}>
                                    <Tooltip title={getColorName(color).name}>
                                        <ColorElement
                                            ref={(element: HTMLButtonElement | null) => {
                                                colorElementsRefs.current[index] = element;
                                            }}
                                    ...
                                    <Popover
                                        ...
                                        anchorEl={colorElementsRefs.current[index]}
                                        anchorOrigin={{
                                            vertical: "top",
                                            horizontal: "center"
                                        }}
