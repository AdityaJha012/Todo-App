...
const Home = () => {
    ...
    useEffect(() => {
        ...
        const interval = setInterval(() => {
            ...
            // Update the key on each interval
    ...
    const renderGreetingWithEmojis = (text: string | ReactNode) => {
        if (typeof text === "string") {
            ...
            // It's already a ReactNode, no need to process it
            return text;
        }
    };
    ...
    return (
        <>
            <GreetingHeader>
                <Emoji unified="14f44b" emojiStyle={emojisStyle} /> &nbsp; {displayGreeting()}
                {name && (
                    <span translate="no">
                        , <span>{name}</span>
                    </span>
                ...
                <TasksCountContainer>
                    <TasksCount glow={settings.enableGlow}>
                        <Box sx={{ position: "relative", display: "inline-flex" }}>
                            ...
                            <ProgressPercentageContainer glow={settings.enableGlow && completedTaskPercentage > 0}>
                                <Typography
                                    variant="caption"
                                    component="div"
                                    color="white"
                                ...
                                >
                                    ${`${Math.round(completedTaskPercentage)}%`}
                                </Typography>
                            </ProgressPercentageContainer>
                        </Box>
                        <TaskCountTextContainer>
